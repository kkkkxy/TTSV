...
def parse_args():
    ...
    parser.add_argument("--data_dir", default="Qwen2.5-Eval/evaluation/data", type=str)
    ...
    parser.add_argument("--tuning_embeddings_path", default='', type=str)
    ...
    for epoch in range(max_func_call):
        ...
        if args.use_vllm:
            ...
            outputs = generate_completions(
                model=llm,
                tuning_embeddings_path=args.tuning_embeddings_path,
                tokenizer=tokenizer,
                prompts=prompts,
